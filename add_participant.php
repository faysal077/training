...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        // Step 2: Insert into Batches if batch_id is not providedd
		/*
        if (!$batch_id) {
		...
		*/
		...
		echo "<script>
                document.addEventListener('DOMContentLoaded', function() {
                    Toastify({
                        text: 'Total training hours: $total_training_hours',
                        duration: 5000,
                        gravity: 'top', 
                        position: 'right', 
                        backgroundColor: '#ff4d4d',
    ...
    <div class="container my-4">
        ...
        <form method="POST" action="">
            ...
            <div class="row mb-3 align-items-center">
                ...
                <div class="col-md-9">
                    <input type="text" id="Official_ID" name="Official_ID" class="form-control"> <!-- Remove required --!>
                </div>
            </div>
